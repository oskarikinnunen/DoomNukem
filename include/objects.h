...
void			objects_init(s_sdlcontext *sdl);

//Should only be used for generated meshes,
//such as ones generated by t_wall or t_meshtri
void			free_object(t_object **object);
t_object		*get_object_by_name(s_sdlcontext sdl, char *name);
t_object		*object_plane(s_sdlcontext *sdl);
t_object		*object_tri(s_sdlcontext *sdl);
