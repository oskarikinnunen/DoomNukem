...
/*   Updated: 2023/03/27 19:45:50 by okinnune         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void gun_pickup_change_player_gun(t_entity *entity, int i, t_world *world)
{
	int	index;
...
void	comp_gun_pickup_update(t_entity *entity, t_world *world)
{
	...
	entity->transform.position.z = \
		gun_pickup->original_z + (ft_absf(sinf(world->clock.time * 0.001f)) * 10.0f);
