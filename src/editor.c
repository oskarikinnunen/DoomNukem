...
/*   Updated: 2022/11/21 21:19:06 by raho             ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	editorloop(t_sdlcontext sdl)
{
	...
	while (ed.gamereturn == game_continue)
	{
		...
		print_ttftext(&sdl, "tab to unlock/lock mouse", (t_point){sdl.window_w / 2, 10});
		print_ttftext(&sdl, "shift + enter to go to playmode", (t_point){sdl.window_w / 2, 30});
		char *fps = ft_itoa(ed.clock.fps);
		print_ttftext(&sdl, fps, (t_point){sdl.window_w - 80, 10});
