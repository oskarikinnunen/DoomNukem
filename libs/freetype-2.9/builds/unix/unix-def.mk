...
MKINSTALLDIRS   := /Users/vlaine/vscode/DoomNukem/libs/freetype-2.9/builds/unix/./install-sh -c -d
...
#
prefix       := /Users/vlaine/vscode/DoomNukem/libs/installed_libs
exec_prefix  := ${prefix}
...
#
PKG_CONFIG         := /Users/vlaine/.brew/bin/pkg-config
REQUIRES_PRIVATE   := zlib, libpng
LIBS_PRIVATE       := -lbz2
LIBSSTATIC_CONFIG  := -lfreetype -lz -lbz2 -L/Users/vlaine/.brew/Cellar/libpng/1.6.37/lib -lpng16 -lz
build_libtool_libs := 
ft_version         := 22.0.16
